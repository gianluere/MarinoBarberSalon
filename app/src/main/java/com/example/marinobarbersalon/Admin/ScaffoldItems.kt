...
fun TopBarDrawer(showDrawer : Boolean, navController: NavController, onClickDrawer : () -> Unit) {
    ...
    val titolo = when (rottaCorrente) {
        Screen.HomeAdmin.route -> "APPUNTAMENTI"
        Screen.Prova.route -> "PROVA"
        Screen.Provadue.route -> "PROVADue"
        Screen.VisualizzaAppuntamenti.route -> "APPUNTAMENTI"
        Screen.VisualizzaAppuntamenti1.route -> "APPUNTAMENTI"
        Screen.VisualizzaClienti.route -> "CLIENTI"
        Screen.DettagliCliente.route -> "CLIENTI"
        Screen.VisualizzaServizi.route -> "SERVIZI"
        Screen.AggiungiServizio.route -> "SERVIZI"
        Screen.VisualizzaProdotti.route -> "PRODOTTI"
        Screen.VisualizzaProdottiDettaglio.route -> "PRODOTTI"
        Screen.AggiungiProdotto.route -> "PRODOTTI"
        Screen.Recensioni.route -> "RECENSIONI"
